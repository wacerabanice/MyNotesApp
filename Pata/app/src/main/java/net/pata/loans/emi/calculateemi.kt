...
import net.pata.R
import net.pata.data.utils.viewBinding
import net.pata.ui.theme.auth.AuthViewModel
import net.pata.ui.theme.auth.EMIViewModel
import net.pata.ui.theme.auth.EmiCalculatorState
...
class EmiCalculationFragment : Fragment(R.layout.fragment_emi_calculation) {
    ...
    private fun EmiCalculatorState(
        isFirstEmiCalculator: Boolean,
        isSecondEmiCalculator: Boolean
    ): EmiCalculatorState {
